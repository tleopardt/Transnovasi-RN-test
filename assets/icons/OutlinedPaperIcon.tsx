...
function OutlinedPaperIcon(props: SvgProps) {
  return (
    <Svg
      width={24}
      height={24}
    ...
    >
      ...
      />
      <Path
        d="M22 10.75h-4c-3.42 0-4.75-1.33-4.75-4.75V2c0-.3.18-.58.46-.69.28-.12.6-.05.82.16l8 8a.751.751 0 01-.53 1.28zm-7.25-6.94V6c0 2.58.67 3.25 3.25 3.25h2.19l-5.44-5.44z"
        fill="#060D24"
      />
    </Svg>
  )
...
export default OutlinedPaperIcon
